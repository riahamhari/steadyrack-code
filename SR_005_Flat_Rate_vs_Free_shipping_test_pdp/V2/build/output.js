					...
					/**
Test name: SR 005 Flat Rate vs Free shipping test - V2
...
var copy = { freeShipping: "FREE Shipping on orders over" };

var init = (uspText2, shippingText2, unicornCartBlock2) => {
  ...
  if (!threshold) return;
  uspText2.innerHTML = `${copy.freeShipping} ${threshold}*`;
  shippingText2.innerHTML = `*${copy.freeShipping}  ${threshold} from local warehouses is available in select countries. Find out more here.`;
  const freeShippingUnlockTxt = unicornCartBlock2.querySelector(".unicorn_cart_unlock span strong");
...
var [[uspText], [shippingText], [unicornCartBlock]] = result.elements;
